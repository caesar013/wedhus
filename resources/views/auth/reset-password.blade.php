                ...
                <div class="row">
                    <div
                        ...
                        <div class="login-brand">
                            <img src="{{ asset('assets/img/logo-goat.png') }}" alt="logo" width="100"
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <p class="text-muted mb-0">We will send a link to reset your password</p>
                                ...
                                <form method="POST" action="{{ route('password.update') }}">
                                    ...
                                    <input type="text" value="{{ request()->route('token') }}" hidden name="token">
